...
public class ItemgiftTile extends Tile
{
    private ToolType toDrop;
    private int color;
    private int count;
    private int ilevel;
    
    public ItemgiftTile(final int id, final ToolType toDrop, final int level) {
        super(id);
        this.toDrop = toDrop;
        this.color = 16776960;
        this.ilevel = level;
    ...
    public void hurt(final Level level, final int x, final int y, final int dmg) {
        level.add(new ItemEntity(new ToolItem(this.toDrop, this.ilevel), x * 16 + this.random.nextInt(10) + 3, y * 16 + this.random.nextInt(10) + 3));
