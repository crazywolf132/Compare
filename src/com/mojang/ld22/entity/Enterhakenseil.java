...
public class Enterhakenseil extends Entity
{
    ...
    private int damage;
    private Mob owner;
    private Enterhakending ent;
    
    public Enterhakenseil(final int dirx, final int diry, final Enterhakending ent) {
        super("Enterhakenseil");
        this.ent = ent;
        this.xdir = dirx;
        this.ydir = diry;
        this.x = ent.x;
